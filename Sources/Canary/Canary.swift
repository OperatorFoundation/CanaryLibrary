...
public class Canary
{
    ...
    {
        uiLogger = logger
        chirp = CanaryTest(serverIP: serverIP, resourceDirPath: configPath, savePath: savePath, testCount: timesToRun, interface: interface, debugPrints: debugPrints, runWebTests: runWebTests)
    }
